...
Provide a better user experience for you users, when they read your posts. Reduce the number outgoing, non-essential links. Hints enables to use info-cards. [Read more about Hints](https://sojourner.co/blog/code/wp-plugin-hints.html).
